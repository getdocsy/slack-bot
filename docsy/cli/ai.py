...
class DocsyCoder:
    ...
    def summarize_changes(self, source_commits: list[Commit]):
        prompt = [
            {
                "role": "system",
                "content": "These changes are made to the code of our application:\n"
                f"{str(source_commits)}\n",
            },
            {
                "role": "system",
                "content": "Please summarize the changes. Focus on the intent of the changes, not the exact code. "
    ...
    def suggest(self, source_commits: list[Commit]):
        ...
        prompt = [
            {
                "role": "system",
                "content": f"These are the changes that were made to the code:\n{summary}\n",
            },
            {
                "role": "system",
                "content": "Here is a list of all the files in our documentation and their headings:\n"
                f"{target_files_with_headings}\n",
            },
            {
                "role": "system",
                "content": "Are changes to the documentation needed?\n"
    ...
    def get_file_paths_to_update(self, suggestion: str) -> list[str]:
        prompt = [
            {
                "role": "system",
                "content": f"Here is the suggestion for changes to the documentation:\n{suggestion}\n",
            },
            {
                "role": "system",
                "content": "Return the paths of the files that need to be updated. One path per line. No other characters. Do not fence them in quotes.",
            },
        ]
