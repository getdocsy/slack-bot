...
prompt = [
    {
        "role": "system",
        "content": "You are my friendly AI coworker. "
...
def main():
    ...
    kraken_api_messages = [
        ...
        (
            "U068ZT2R7DG",
            "https://kraken.dev.meshcloud.io/docs/index.html. It's a bit hidden there also exist a ticket for it https://app.clickup.com/t/86bwhj5m0",
        ),
        ("U068ZT2R7DG", "thanks"),
        (
            "U068T9HGHAA",
            "Hey there <@U068ZT2R7DG>! You learned something new today. Do you want me to come up with a Knowledge base entry for that?",
        ),
        (
            "U068T9HGHAA",
            "All right, <@U068ZT2R7DG>. I'll get back to you with a suggestion",
        ),
    ]
